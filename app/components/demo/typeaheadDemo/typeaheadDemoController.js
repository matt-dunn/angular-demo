define([
    'app',
    'angularjsView!./typeaheadDemo.html'
], function(app) {
    "use strict";

    app.register.controller('Components.Demo.TypeaheadDemoController', ['$scope', '$http', function($scope, $http) {
        console.log("SETUP Components.Demo.TypeaheadDemoController");
